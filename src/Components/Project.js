...
const repoURL="https://github.com/MegumiYam/";
const portfolioRepo="portfolio";
const weatherRepo="WeatherApp_Vue";
const calRepo="Calculator_QT";
                    ...
                    <Card style={{ width: '18rem' }}>
                        ...
                        <Card.Body>
                            ...
                            <Button variant="primary">
                                <a href={repoURL+portfolioRepo} target="_blank" rel="noreferrer">
                                    View Project
                                </a>
                            </Button>
                        </Card.Body>
                ...
                <Col>
                    <Card style={{ width: '18rem' }}>
                        ...
                        <Card.Body>
                            ...
                            <Button variant="primary">
                                <a href={repoURL+weatherRepo} target="_blank" rel="noreferrer">
                                    View Project
                                </a>
                            </Button>
                        </Card.Body>
                ...
                <Col>
                    <Card style={{ width: '18rem' }}>
                        ...
                        <Card.Body>
                            ...
                            <Button variant="primary">
                                <a href={repoURL+calRepo} target="_blank" rel="noreferrer">
                                    View Project
                                </a>
                            </Button>
                        </Card.Body>
